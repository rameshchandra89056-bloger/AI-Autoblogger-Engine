...
def clean_ad_garbage(text):
    ...
    # ANTI-MARKDOWN SHIELD: AI ki galti theek karega
    text = text.replace("**", "").replace("```html", "").replace("
```", "")
    return text.strip()
...
# --- CSS WAHI HOGA, BAS NAV BAR MEIN SEARCH BAR WAPAS AAYEGA ---
