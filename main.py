...
try:
    ...
    # --- DESI AUR AAM ZINDAGI WALE PROMPTS ---
    intro_prompt = f"Topic: '{current_topic}'. Ek bohot lamba aur detailed Introduction (kam se kam 250 words) likho. Niyam 1: Bhasha ekdum 'Desi' aur simple honi chahiye. Niyam 2: Ek aam insaan ki kahani se shuru karo (jaise UP/Kanpur ke kisi auto-driver, kisaan, ya chote dukandar ka udaharan jo apne phone se kama raha ho). Kitabi bhasha bilkul nahi. Uske baad ek Clickable TOC likho. Template for TOC: <div style='background: #fffafa; border-left: 5px solid #da251c; padding: 20px; border-radius: 8px; margin-bottom: 25px;'><h3 style='color: #da251c; margin-top: 0;'>📍 Is Article Mein Kya Hai:</h3><ul style='list-style:none; padding:0;'><li>👉 <a href='#basic' style='color:#da251c; text-decoration:none; font-weight:bold;'>1. Basic Samajh (0 to 30%)</a></li> <li>👉 <a href='#deep' style='color:#da251c; text-decoration:none; font-weight:bold;'>2. Tools aur Deep Detail (30 to 70%)</a></li> <li>👉 <a href='#pro' style='color:#da251c; text-decoration:none; font-weight:bold;'>3. Pro Execution Hacks (70 to 100%)</a></li></ul></div>. Sirf HTML code do (<h2>, <p>, <a>). Markdown nahi."
    chunk_1 = ask_ai(intro_prompt, retries=2)
    
    body_prompt = f"Topic: '{current_topic}'. Ab article ki main body likho. Theek 3 sub-headings (<h2>) likho. Niyam 1: Pehle <h2> mein id='basic' lagao. Dusre mein id='deep' lagao. Teesre mein id='pro' lagao. Niyam 2: Bhasha dostana aur 'desi' rakho. Aam zindagi (real-world) ke practical examples do taaki koi beginner bhi samajh jaye. Niyam 3: Hawa-hawai baatein nahi. Kam se kam 3 asali Tools/Websites/Software ke naam do aur step-by-step batao ki unhe kaise use karna hai. Niyam 4: Har <h2> wale section ke baad exactly 1 baar [PHOTO] tag likho. Sirf HTML code do."
...
<div style="background: #ffffff; padding: 25px; border-radius: 12px; margin-top: 40px; margin-bottom: 40px; box-shadow: 0 5px 20px rgba(0,0,0,0.05); display: flex; align-items: center; gap: 20px; border-left: 5px solid #da251c; flex-wrap: wrap;">
    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Mohit&backgroundColor=da251c" style="width: 80px; height: 80px; border-radius: 50%; border: 3px solid #f0f0f0;">
    <div style="flex: 1;">
...
# --- GOOGLE ADSENSE READY LEGAL PAGES (100% COMPLIANT) ---
pages = {
    "about": ("About Us", "<h2 style='color: var(--main-red); margin-bottom: 15px; font-size: 28px;'>Hamari Kahani (About Us)</h2><p style='font-size: 18px; margin-bottom: 25px; color: #333;'>Namaste! <strong>Digital Kamai Hub</strong> mein aapka swagat hai. Yeh blog sirf jankari nahi deta, balki aapko practically sikhata hai ki 2026 mein AI aur Automation ka istemal karke smart income kaise banayi jaye.</p><h2 style='color: var(--main-red); margin-bottom: 15px; font-size: 24px;'>🎯 Hamara Mission</h2><p style='font-size: 18px; margin-bottom: 25px; color: #333;'>Hamara maqsad (mission) hai har us aam insaan tak highest level ki tech jankari asaan Hindi bhasha mein pahunchana, taaki wo ghar baithe apne smartphone se kama sake. <strong>Smart Work > Hard Work.</strong></p><h2 style='color: var(--main-red); margin-bottom: 15px; font-size: 24px;'>👨‍💻 Meet The Founder: Mohit (The AI Millionaire)</h2><div style='background: #fafafa; padding: 25px; border-left: 5px solid var(--main-red); border-radius: 8px; margin-bottom: 30px;'><p style='font-size: 17px; margin-bottom: 15px; color: #222;'>Mohit ek Full-Stack Web Developer, Blogger, aur AI enthusiast hain. Unka manna hai ki agar koi kaam aap roj manually karte hain, toh use Automate kiya ja sakta hai.</p></div>"),
...
send_telegram_msg(urllib.parse.quote(f"✅ FINAL SUCCESS: AdSense Pages & Desi Prompt Live!\n📝 Kul Post: {len(posts_db)}\n🌐 Link: {blog_url}"))
